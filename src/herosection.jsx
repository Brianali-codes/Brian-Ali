...
import ScrollDownIndicator from './components/scroller';
...
export default function Herosection() {
    ...
    return (
        <div className='relative flex flex-cl h-screen justify-center items-center'>
            ...
            <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2" id="ScrollIndicator" >
                <a href="#ABOUT">
                    <ScrollDownIndicator />
                </a>
            </div>

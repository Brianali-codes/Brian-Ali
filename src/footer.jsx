    ...
    return (
        <footer id="Contacts" className="bg-black h-60 flex flex-col justify-between p-2 m-0">
            <div className="flex flex-row justify-center">
                <p className="text-white font-Josefin-Sans">CONTACT ME:</p>
            </div>

            <div className="flex flex-row justify-center gap-4">
            <a href="https://www.instagram.com/bryce._.six/" target='_blank'><FontAwesomeIcon icon={faInstagram} size="2x" className='text-white hover:text-cyan-400 hover:cursor-pointer' /></a>
            ...
            <div className="flex flex-row justify-center">
                <p className="text-white"> Brian Ali || All rights reserved || © 2024 </p>
            </div>
        </footer>
    )
}
